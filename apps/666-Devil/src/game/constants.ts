...
const wSizeRatios = { width: 0.2, height: SPECIAL_SYMBOL_SIZE * 0.15 };
// Calculated to match original static sprite size: (484×427 @ 1.243) / (80×70 @ scale:2)
const sSizeRatios = { width: 0.38, height: 0.38 };
...
export const SYMBOL_INFO_MAP = {
	H1: {
		...
		win: {
			...
			sizeRatios: { width: 0.5 * 1.1, height: HIGH_SYMBOL_SIZE * 0.65 },
		},
	...
	H3: {
		...
		win: {
			...
			assetKey: 'H3',
			animationName: 'animtion0',
			sizeRatios: { width: 0.5 * 1.0, height: HIGH_SYMBOL_SIZE * 0.6 },
		},
	...
	L1: {
		...
		win: {
			...
			assetKey: 'L1',
			animationName: 'animtion0',
			sizeRatios: { width: 0.5 * 0.95, height: LOW_SYMBOL_SIZE * 0.7 },
		},
	...
	L3: {
		...
		win: {
			...
			sizeRatios: { width: 0.5 * 0.85, height: LOW_SYMBOL_SIZE * 0.7 },
		},
	...
	L4: {
		...
		win: {
			...
			assetKey: 'L4',
			animationName: 'animtion0',
			sizeRatios: { width: 0.5 * 0.9, height: LOW_SYMBOL_SIZE * 0.7 },
		},
	...
	W: {
		...
		static: wStatic,
		spin: wStatic,
		win: { type: 'spine', assetKey: 'W', animationName: 'animtion0', sizeRatios: wSizeRatios },
		land: {
			type: 'spine',
			assetKey: 'W',
			animationName: 'animtion0',
