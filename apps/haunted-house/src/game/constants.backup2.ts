...
export const SYMBOL_INFO_MAP = {
	...
	W: {
		...
		static: wStatic,
		spin: wStatic,
		win: { type: 'spriteSheet', assetKey: 'W_ANIMATION', sizeRatios: { width: 1.3, height: 1.3 } },
		land: {
			type: 'spriteSheet',
			assetKey: 'W_ANIMATION',
	...
	S: {
		...
		win: {
			type: 'spriteSheet',
			assetKey: 'S_ANIMATION',
			sizeRatios: { width: 1.4, height: 1.4 } },
		land: sStatic,
	},
} as const;
