...
export const SYMBOL_INFO_MAP = {
	...
	// P = Prize Lady (placeholder using H1 asset until dedicated art is ready)
	P: {
		explosion,
		win: { type: 'spine', assetKey: 'H1', animationName: 'h1', sizeRatios: { width: 0.5 * 1.15, height: HIGH_SYMBOL_SIZE * 0.57 } },
		postWinStatic: h1Static,
		static: h1Static,
		spin: h1Static,
		land: h1Static,
