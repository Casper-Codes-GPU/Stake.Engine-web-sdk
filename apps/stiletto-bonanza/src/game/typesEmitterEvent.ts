...
import type { EmitterEventCollectionMeter } from '../components/CollectionMeter.svelte';
import type { EmitterEventMilestonePopup } from '../components/MilestonePopup.svelte';
...
export type EmitterEventGame =
	...
	// Stiletto Bonanza
	| EmitterEventCollectionMeter
	| EmitterEventMilestonePopup;
