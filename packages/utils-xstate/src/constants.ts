...
export const STATE_RENDERED = 'rendered' as const;
...
export const STATE_FORCE_RESULT = 'forceResult' as const;
export const STATE_REPLAY = 'replay' as const;
export const STATE_END = 'end' as const;